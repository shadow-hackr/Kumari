...
def tokenz():
    ...
    try:
        ...
        print'Link Tutor : \x1b[0;92mhttps://www.facebook.com/KUMARI.008\n'
        ...
        try:
            ...
            print ' \x1b[0;97m[\xe2\x80\xa2] Token is Valid'

            raw_input(' \x1b[0;97m[\x1b[0;92m√\x1b[0;97m] Press Enter Go to Menu')
            ...
            print ' \x1b[0;97m[\xe2\x80\xa2] Token is Invalid'

            raw_input(' \x1b[0;97m[\x1b[0;91m×\x1b[0;97m] Press Enter To Enter New Token')
...
def menu():
    ...
    print ' \x1b[0;97m[1] Crack with b-api (Fast Crack)'

    print ' \x1b[0;97m[2] Crack with mbasic (Low Crack)'

    print ' \x1b[0;97m[3] Crack with free (Low Crack)'

    print ' \x1b[0;97m[\x1b[0;91m0\x1b[0;97m] Return'
...
def pilih_menufree():
    ...
    if ask == '':
        ...
        print "\n [*] Fill in 'me' if you want to crack from friends list"
        ...
        if ress == '':
            ...
            os.system('paint out/CP-%s-%s-%s.txt' % (ha, op, ta))
        ...
        print ' [!] Successfully Remove Token'
    ...
    ask = raw_input(' [?] Want to use Password Manual? Y/d : ')
    ...
    print ' [+] File \x1b[0;92mOK\x1b[0;97m Stored in : out/OK-%s-%s-%s.txt' % (ha, op, ta)

    print ' [+] File \x1b[0;93mCP\x1b[0;97m Stored in : out/CP-%s-%s-%s.txt' % (ha, op, ta)

    print ' [!] Seding Prosess Crack\n'
...
def menumbasic():
    ...
    print ' [1] Crack with Public/Friend'

    print ' [2] Crack with Total Followers'

    print ' [3] Crack with Like Postingan'
...
def pilih_menumbasic():
    ...
    if ask == '':
        ...
        print ' [!] chose Right one !'

        exit()

    elif ask == '1' or ask == '01':

        print "\n [*] Isi 'me' Jika Ingin Crack with List friend"
        ...
        print "\n [*] feel 'me' Jika Ingin Crack Follower Sendiri"
